    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <!-- <Zoom :skuImageList='skuInfo.skuImageList'/> 显示正常，但报错，解释在zoom组件里面-->
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 以前的路由跳转：从A路由跳转到B路由， -->
                <!-- 这里在加入购物车进行路由跳转之前，还要把购买的产品信息通过请求的形式通知服务器，服务器进行相应的存储 -->
